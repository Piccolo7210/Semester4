...
void report(vector<process> processes);
...
int main(){
    ...
    for(auto &p : processes){
        if(time<p.arrival_time){
            ...
            //cout<<p.p_name<<" waits" << p.waiting_time<<endl;
            tracks.push_back(y);
        }
        else{
            track y;
            ...
            p.ta_time=time-p.arrival_time;
            p.waiting_time=p.ta_time-p.burst_time;
            // cout<<p.p_name<<" tat" << p.ta_time<<endl;
            //cout<<p.p_name<<" waits" << p.waiting_time<<endl;
            tracks.push_back(y);
        }
    }
...
void report( vector<process> processes){
   ...
   for(auto p : processes){
        cout<<"Process ID : "<<p.p_name<<" "<<p.ta_time<<endl;   
        }
        cout<<endl;
        cout<<"Waiting Time: "<<endl;
   for(auto p : processes){
        cout<<"Process ID : "<<p.p_name<<" "<<p.waiting_time<<endl;   
        }
}
